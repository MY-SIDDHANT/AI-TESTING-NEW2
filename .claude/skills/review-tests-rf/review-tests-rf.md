---
name: review-tests
description: Review Robot Framework test files for quality, best practice compliance, and correctness
...
1. `robotframework-best-practices` skill — The standard. Every rule is a review criterion.
...
If none specified, review all `tests/*.robot`.
